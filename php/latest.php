...
// Fetch latest games
$latest_games = $conn->query("SELECT * FROM games WHERE category_id = 3 LIMIT 6");
...
<body>
    ...
    <section id="catalog" class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-3">Latest Games</h2>
            <p class="text-center mb-4">Check out the latest games added to our collection!</p>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php if ($latest_games->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p class="text-center">No latest games available at the moment.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>

...
$featured_games = $conn->query("SELECT * FROM games WHERE category_id = 1 LIMIT 6");
...
<body>
    ...
    <section id="catalog" class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-3">Featured Games</h2>
            <p class="text-center mb-4">Discover our top-rated games picked just for you!</p>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php if ($featured_games->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p class="text-center">No featured games available at the moment.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>

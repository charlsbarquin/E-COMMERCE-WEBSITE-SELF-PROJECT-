...
$recommended_games = $conn->query("SELECT * FROM games WHERE category_id = 2 LIMIT 6");
...
<body>
    ...
    <section id="catalog" class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-3">Recommended Games</h2>
            <p class="text-center mb-4">Check out the best games we've recommended for you!</p>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php if ($recommended_games->num_rows > 0): ?>
                    <?php while ($game = $recommended_games->fetch_assoc()): ?>
                        <div class="col">
                            <div class="card shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <!-- View Details button links to the game details page -->
                                        <a href="game_details.php?id=<?= htmlspecialchars($game['game_id'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-warning">View Details</a>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p class="text-center">No recommended games available at the moment.</p>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <button id="scrollToTopBtn" class="btn btn-warning rounded-circle"
        style="display: none; position: fixed; bottom: 20px; right: 20px;">↑</button>

...
$special_offers = $conn->query("SELECT * FROM special_offers LIMIT 6");
...
<body>
    ...
    <section id="special-offers" class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-3">Special Offers</h2>
            <p class="text-center mb-4">Check out the best deals and discounts on your favorite games!</p>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php if ($special_offers->num_rows > 0): ?>
                    <?php while ($offer = $special_offers->fetch_assoc()): ?>
                        <div class="col">
                            <div class="card shadow-lg position-relative">
                                <!-- Discount Badge -->
                                <div class="badge bg-danger position-absolute" style="top: 10px; right: 10px;">
                                    <?= htmlspecialchars($offer['discount']); ?> OFF
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-primary">Price: ₱<?= number_format($offer['price'], 2); ?></p>
